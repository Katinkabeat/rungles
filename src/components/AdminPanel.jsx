        ...
        <ul className="space-y-2">
          {games.map(g => {
            ...
            return (
              <li
                key={g.id}
                className="rounded-xl px-3 py-2.5 bg-white border border-rungles-100 dark:bg-[#1f1240] dark:border-[#2d1b55]"
              >
                ...
                {isPrompting && (
                  <div className="mt-2 space-y-2">
                    <input
                      ...
                      className="w-full px-2 py-1.5 rounded-lg border border-rungles-200 dark:border-[#2d1b55] dark:bg-[#1a0e30] text-xs text-rungles-700 dark:text-rungles-100 focus:border-rungles-400 focus:outline-none"
                    />
